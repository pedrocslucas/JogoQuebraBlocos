...
#define font
font = pygame.font.SysFont('Constantia', 22)
...
while run:
	...
	if not live_ball:
		if game_over == 0:
			draw_text('CLIQUE COM O MOUSE PARA COMEÇAR', font, text_col, 90, screen_height // 2 + 100)
		elif game_over == 1:
			draw_text('VOCÊ VENCEU!', font, text_col, 220, screen_height // 2 + 50)
			draw_text('CLIQUE COM O MOUSE PARA COMEÇAR', font, text_col, 90, screen_height // 2 + 100)
		elif game_over == -1:
			draw_text('VOCÊ PERDEU!', font, text_col, 220, screen_height // 2 + 50)
			draw_text('CLIQUE COM O MOUSE PARA COMEÇAR', font, text_col, 90, screen_height // 2 + 100)
